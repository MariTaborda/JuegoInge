...
public class MissionBuildBridge : Mission {
	...
	void setTitle() {
		title = "Es hora de atravesar el mar...";
	}
	
	// change mission description section text here
	void setDescriptionText() {
		description = "Utiliza el personaje constructor y escoge la herramienta martillo para crear un puente! Logra atravesar el rio y consigue llegar a la bandera! Vos podes!";
	}
